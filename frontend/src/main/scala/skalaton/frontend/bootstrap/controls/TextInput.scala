...
object TextInput {
  ...
  def apply(value: Option[String],
            ...
            onFocus: Callback = Callback.empty,
            onBlur: Callback = Callback.empty,
            onKeyPress: String => Callback = _ => Callback.empty, placeholder: Option[String] = None, disabled: Boolean = false): Unmounted[Props] =
    component(Props(value, onChange, onFocus, onBlur, onKeyPress, placeholder, disabled))
